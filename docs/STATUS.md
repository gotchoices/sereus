...
- [x] `packages/cadre-core/test/control-database-offline-peers.spec.ts` — a cadre of **more than
  ...
  fails loudly. **Recovery is covered as a unit shape too**, on a relay started from a fixed key at
...
only test at that date; the file has grown to **six** tests since — the joiner-authored join
2026-07-30, then physical block replication and manager-actions-from-the-second-node 2026-07-31,
then offline durability with the founder STOPPED 2026-08-03. Four of the six are **intermittent**
on a platform fault outside this repo, tracked as
`blocked/strand-unique-index-sync-stale-revision`; a 2026-08-03 whole-file run had three of those
four red), and
