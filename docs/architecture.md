...
> **Convergence prerequisites and current status.** The replicated `CadrePeer` form described above now replicates in the wiring; one prerequisite for *production* convergence remains (auto-connect):
>
