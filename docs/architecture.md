...
- Application schema
- Peer cohort (intended: union of all member cadres; today: this party's cadre only — see [Some Questions](strands.md#some-questions) in `strands.md` for the open cross-party strand discovery question this depends on)
