 ...
 * `quereus-plugin-sereus`, the two `@optimystic/quereus-plugin-*` packages, and
 * `@optimystic/db-core`, all reached transitively through `cadre-core`), so
 * only missing entries fail — extra ones are the point.
 */

import { describeBuildTargets, packageRootFrom } from '../../../test-harness/build-targets-spec.js';
import { TARGETS } from './global-setup.js';

describeBuildTargets('reference-app-rn', {
