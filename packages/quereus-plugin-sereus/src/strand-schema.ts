...
export const STRAND_SCHEMA = `    table Header (
    ...
    table Manager (
        ...
        -- not yet converged on the delete still shows the manager row, so the
        -- ex-manager's OWN key could still admit there until the delete arrives. Only
        -- that one key; no stranger gains anything. Same convergence class as the
        -- MinOneMember / NotRevoked local-visibility notes; not solved here.
        constraint Authorized check on insert, delete (
